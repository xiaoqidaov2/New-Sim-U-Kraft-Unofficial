...
import com.xiaoliang.simukraft.client.gui.HUDPositionEditorScreen;
...
/**
 * simukraft: 客户端配置界面 - 菜单版本
 * 使用LDLibMenuScreen基类，被其他模组识别为普通菜单而非容器
 */
@OnlyIn(Dist.CLIENT)
public class ModConfigMenuScreen extends LDLibMenuScreen {
    ...
    private static ModConfigMenuScreen currentInstance;

    public ModConfigMenuScreen(Screen parent) {
